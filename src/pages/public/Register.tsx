...
export default function Register() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    register({ name, email, password, confirmed_password }).then((res) => {
      if (res.data.errors) {
        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
          ...
          <div className="absolute bottom-12 left-12 max-w-md z-10">
            <h1 className="font-syne text-5xl font-extrabold text-white leading-tight mb-4">
              Tu próximo viaje <span className="text-blue-500">empieza acá.</span>
            </h1>
            <p className="text-neutral-300 text-lg leading-relaxed">
              Creá tu cuenta en segundos y accedé a nuestra flota exclusiva de vehículos.
            </p>
          </div>
        </div>

        {/* ── LADO DERECHO: formulario ── */}
        <div className="flex-1 flex flex-col justify-center px-8 py-12 lg:px-20 overflow-y-auto">
          <div className="max-w-md w-full mx-auto">
            ...
            {/* Título */}
            <div className="mb-8">
              <h2 className="font-syne font-extrabold text-3xl text-white mb-2">Creá tu cuenta</h2>
              <p className="text-neutral-500 text-sm">Completá el formulario para comenzar</p>
            </div>
